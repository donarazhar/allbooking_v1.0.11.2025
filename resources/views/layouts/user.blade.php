                ...
                <div class="flex items-center">
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="flex items-center space-x-3 focus:outline-none hover:bg-gray-50 px-3 py-2 rounded-lg transition-colors">
                            <div
                                class="h-10 w-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white font-bold overflow-hidden">
                                @if (Auth::user()->foto)
        ...
        <div class="grid grid-cols-5 h-16">
            ...
            <a href="{{ route('user.booking') }}"
             ...
             <a href="{{ route('user.my-bookings') }}"
                ...
                <span class="text-[10px] font-medium">Booking</span>
            </a>
